...
### 本体ROMをパッチを当てたMONITOR SP-1002に交換しなくてもアプリケーションからのロード、セーブをSD対応とさせるパッチあてWindows用ツール「CMT2SD_CHECK」を公開しました。(2022.6.29)詳細は、CMT2SD_CHECKフォルダ中のREADME.mdを参照してください。
