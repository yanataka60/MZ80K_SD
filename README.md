...
　また、一部のMZ-80K用ソフトは、0h!MZ別冊 ADVANCED MZ-700に掲載されているSP-1002のMZ-700対応版 NZ-700が必要です。
...
　注)MZ-700でこの機能を使うには0h!MZ別冊 ADVANCED MZ-700に掲載されているSP-1002のMZ-700対応版 NZ-700が必要です。MZ-80Kでは問題ありません。
...
なお、起動確認していないアプリケーションでも起動だけであればFDコマンドで起動できるはずです。
...
　アプリケーションのLOADコマンドの中でFDLコマンドが使える機能がMZ-700 MONITOR 1Z-009A、1Z-009B環境下では使えないことが判明しました。原因、対策について調査中です。
