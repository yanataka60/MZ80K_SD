...
　　8080用テキスト・エディタ＆アセンブラ(注2)(注4)【I/O 1980年9月号】
...
注3)LOAD時にエラー表示が出ますが、LOADは正常に終わっています。エラー表示が出ないよう調査中です。

注4)LOAD時にエラー表示が出ますが、LOADは正常に終わっています。以降Lコマンドのみ挙動が正常ではないようです。調査中。
